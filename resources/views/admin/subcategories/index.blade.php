                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="active breadcrumb-item" aria-current="page"><a href="/#">Sub Category List</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <div class="create">
                                <div class=" h4 card-title">sub category</div>
                                <form class="row g-3" action="{{ route('subcategory.store') }}" method="GET">
                                    @csrf
                                    @method('get')
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" name="name" placeholder="Add Sub Category"
                            ...
                            <table class="align-middle table-nowrap  table category">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th scope="col">N° of products in this Sub_category </th>
