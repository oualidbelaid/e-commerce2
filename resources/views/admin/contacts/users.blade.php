                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="active breadcrumb-item" aria-current="page"><a href="/#">Client List</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                                ...
                                <tbody>
                                    @foreach ($clients as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <p class="mb-1">
                                                    {{ '0' . $item->profile->phone != 0 ? $item->profile->phone : '' }}</p>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('user.destroy', [$item->id]) }}" type="button"
                                                    class="btn btn-sm btn-rounded waves-effect waves-light">
