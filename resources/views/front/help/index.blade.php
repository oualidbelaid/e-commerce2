                ...
                <div class="col-lg-2">
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <a class="nav-link active" id="v-pills-gen-ques-tab" data-bs-toggle="pill" href="#v-pills-gen-ques"
                            ...
                            <i class="fal fa-question  d-block check-nav-icon mt-4 mb-2"></i>
                        ...
                        <a class="nav-link" id="v-pills-privacy-tab" data-bs-toggle="pill" href="#v-pills-privacy"
                            ...
                            <i class="fal fa-shield-check d-block check-nav-icon mt-4 mb-2"></i>
                        ...
                        <a class="nav-link" id="v-pills-support-tab" data-bs-toggle="pill" href="#v-pills-support"
                            ...
                            <i class="fal fa-user-headset  d-block check-nav-icon mt-4 mb-2"></i>
                                    ...
                                    <div class="faq-box d-flex mb-4">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <p class="text-muted">New common language will be more simple and regular
                                                than the existing European languages. It will be as simple as occidental.
                                            </p>
                                        </div>
                                    </div>
                                    <div class="faq-box d-flex mb-4">
                                    ...
                                    <div class="faq-box d-flex mb-4">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <p class="text-muted">Their separate existence is a myth. For science,
                                                music, sport, etc, Europe uses the same vocabulary.</p>
                                        </div>
                                    </div>
