        ...
        <div class="row ">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Search</h4>
                ...
                <div class="col-lg-12">
                    ...
                    <ul id="more_product" class="pagination pagination-rounded justify-content-end mb-2">
                        <li class="page-item  {{ !request()->get('page') || request()->get('page') == 1 ? 'disabled' : '' }}">
                            <a class="page-link"
                                href="{{ url()->current() . '?q=' . $key . '&&page=' . request()->get('page') - 1 }}"
                                aria-label="Previous">
                        ...
                        <li class="page-item  {{ !request()->get('page') || request()->get('page') == 1 ? 'active' : '' }}">
                            <a class="page-link" href="?q={{ $key }}&&page=1">1</a>
                        </li>
                        ...
                        <li class="page-item {{ $nbr_pr < 1 || request()->get('page') >= $nbr_pr ? 'disabled' : '' }}">
                            <a class="page-link"
                                href="{{ request()->get('page') != 0 ? url()->current() . '?q=' . $key . '&&page=' . request()->get('page') + 1 : url()->current() . '?q=' . $key . '&&page=' . request()->get('page') + 2 }}"
                                aria-label="Next">
